...
|---|---|---|
| I | OCR-пилот 300 стр. в `02_ЭТАЛОННАЯ_РАЗМЕТКА_И_МЕТОДИКА/ocr_pilot_20260811`; 11 731 стр. train без текстового слоя | Живой OCR в запросе + CA на пилоте; GAP-CAP-OCR открыт |
